...
public class FileUtils {
    ...
    public static final String characterEncodingCode = "GB2312";//字符编码类型
    ...
    /**
     *将File数组转为List<File>集合
     *
     * @param files
     * @return
     */
    public static List<File> fileList2ArrayList(File[] files) {
     ...
     * @return
     */
    public static List<File> listFolders(File[] files) {
        ...
        try{
            ...
            if(files != null){
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    file_t.setFileName(file.getName());
                    file_t.setPath(file.getPath());
                    if (type == "all") {
                        result.add(file_t);
                    } else if (type == "folder") {
                        String str = file_t.getFileName();
                        ...
                        String[] strArray = file_t.getFileName().split("\\.");
    ...
    public static String getLastModifiedTime(File file) {
        ...
        lastModifiedTime = formatter.format(file.lastModified());
