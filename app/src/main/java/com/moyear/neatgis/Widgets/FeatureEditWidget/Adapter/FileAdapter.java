package com.moyear.neatgis.Widgets.FeatureEditWidget.Adapter;
...
public class FileAdapter extends BaseAdapter {
    ...
    public FileAdapter(Context c, List<FileInfo> list) {
        this.fileList = list;
        this.context = c;
    }

    public void setAdapterList(List<FileInfo> infos) {
        this.fileList = infos;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.txtName.setText(fileList.get(position).getFileName());
        holder.txtName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    ...
                    String[] strArray = fileList.get(position).getFileName().split("\\.");
            ...
            public boolean onLongClick(View v) {
                ...
                builder.setNegativeButton("确定", new DialogInterface.OnClickListener()
                {
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        boolean bool = FileUtils.deleteFiles(fileInfo.getPath());
                        if(bool){
