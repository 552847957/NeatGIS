package com.moyear.neatgis.Widgets.FeatureEditWidget.Media;
...
import com.moyear.neatgis.Utils.TimeUtils;
...
public class VoiceAlertView {
    ...
    private ImageButton btnVoice;//录音
    ...
    public VoiceAlertView(final Context context, String audioPath, String name){
        ...
        this.btnVoice = view.findViewById(R.id.widget_view_feature_edit_alert_voice_btnVoice);
