package com.moyear.neatgis.Widgets.FeatureEditWidget.Resource;
...
public class DrawToolsResource {
    ...
    public RelativeLayout rlFeatureTemple;//add by moyear on 2020.02.18
    ...
    private void initResource() {
        ...
        rlFeatureTemple = view.findViewById(R.id.widget_view_feature_edit_item_feaTempleteView);
    ...
    public class FeatureAddTools{
        ...
        public TextView txtBtnExit;//退出新建要素按钮
