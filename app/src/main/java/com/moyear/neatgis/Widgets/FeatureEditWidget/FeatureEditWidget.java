package com.moyear.neatgis.Widgets.FeatureEditWidget;
...
import com.moyear.neatgis.Widgets.FeatureEditWidget.Adapter.FeatureTempleteAdapter;
import com.moyear.neatgis.Widgets.FeatureEditWidget.Adapter.FieldAdapter;
import com.moyear.neatgis.Widgets.FeatureEditWidget.Listener.MapSelectOnTouchListener;
import com.moyear.neatgis.Widgets.FeatureEditWidget.Media.MediaAlertView;
import com.moyear.neatgis.Widgets.FeatureEditWidget.Media.VoiceAlertView;
import com.moyear.neatgis.Widgets.FeatureEditWidget.Resource.DrawToolsResource;
    ...
    private void initEditFeatureTools() {
        ...
        drawToolsResource.getFeatureEditTools().txtBtnExit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                drawToolsResource.getFeatureEditTools().toolsView.setVisibility(View.GONE);//隐藏要素编辑工具

                drawToolsResource.rlFeatureTemple.setVisibility(View.VISIBLE);//显示要素模板界面

                featureSelectOnTouchListener.clear();//清空当前选择

                drawToolsResource.gridViewFeatureTemplete.setEnabled(true);
                //drawToolsResource.gridViewFeatureTemplete.setVisibility(View.VISIBLE);
            }
        });
