...
import com.moyear.neatgis.EventBus.BaseWidgetMsgEvent;
        ...
        if (isPad) {
            ...
            try {
                ...
                if (txtWidgetName != null) {
                    txtWidgetName.setTextColor(context.getResources().getColor(R.color.black));
                }
            } catch (IOException e) {
                e.printStackTrace();
            }
    ...
    public void inactive() {
        ...
        if (isPad) {
            ...
            try {
                ...
                txtWidgetName.setTextColor(context.getResources().getColor(R.color.deep_gray));
            } catch (IOException e) {
                e.printStackTrace();
            }
