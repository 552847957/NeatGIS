package com.moyear.neatgis.BMOD.MapModule.View;
...
import com.moyear.neatgis.BMOD.MapModule.BaseWidget.WidgetManager;
import com.moyear.neatgis.Config.AppConfig;
import com.moyear.neatgis.Config.Entity.ConfigEntity;
import com.moyear.neatgis.Config.Entity.WidgetEntity;
import com.moyear.neatgis.BMOD.MapModule.Map.MapManager;
import com.moyear.neatgis.BMOD.MapModule.Resource.ResourceConfig;
import com.moyear.neatgis.Base.BaseActivity;
...
//        toolbar.setNavigationIcon(null);//设置不显示回退按钮
    ...
    private void initNavigationView() {
        mNavView.setItemTextColor(ColorStateList.valueOf((getResources().getColor(R.color.textColor))));
        ...
        if (mConfigEntity != null) {
            ...
            Log.e("0000","widgetEntity.getClassname()");

            for (int i = 0; i < mListWidget.size(); i++) {
                WidgetEntity widgetEntity = mListWidget.get(i);

                Log.e("aaaaaa",widgetEntity.getClassname());

                mNavView.getMenu().add(widgetEntity.getClassname());
